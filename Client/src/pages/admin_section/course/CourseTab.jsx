...
const CourseTab = () => {
  ...
  useEffect(() => {
    if (getCourseByIdData?.course && !hasLoaded) {
  ...
  const updateCourseHandler = async () => {
    ...
    formData.append("coursePrice", String(input.coursePrice));
  ...
  return (
    <Card>
      <CardHeader className="flex flex-row justify-between mt-10">
        <div>
        ...
        <div className="space-y-4 mt-5">
          <div>
            ...
            <Input
              ...
              placeholder="Ex. Fullstack developement Course"
            />
          </div>
          <div>
